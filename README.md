...
| Frontend framework | Vanilla HTML/CSS/JS, no framework | Considered Streamlit (not flexible enough for the interactive term-highlighting and click-to-edit UI) and React (component/state management overhead unjustified at this scope, given 6 screens sharing one plain state object). |
